...
impl Device {
    ...
    fn remap_bindings(
        ...
        nb_map: &mut HashMap<String, pso::DescriptorBinding>,
    ) {
    ...
    fn combine_seperate_images_and_samplers(
        ...
        let mut id_map = HashMap::<u32, (pso::DescriptorSetIndex, pso::DescriptorBinding)>::new();
        let res = ast.get_shader_resources().unwrap();
    ...
    fn populate_id_map(
        &self,
        ast: &mut spirv::Ast<glsl::Target>,
        id_map: &mut HashMap<u32, (pso::DescriptorSetIndex, pso::DescriptorBinding)>,
        all_res: &[spirv::Resource],
    ) {
        for res in all_res {
            let set = ast.get_decoration(res.id, spirv::Decoration::DescriptorSet).unwrap();
    ...
    fn compile_shader(
        ...
        match *point.module {
            ...
            n::ShaderModule::Spirv(ref spirv) => {
                ...
                let mut name_binding_map = HashMap::<String, pso::DescriptorBinding>::new();
